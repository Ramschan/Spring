...
[source,text]
----
http://localhost:8090/greeting?name=User
----
====
...
Now that the service is up, visit `http://localhost:8090/greeting`, where you should see:
...
`http://localhost:8090/greeting?name=User`. Notice how the value of the `content`
